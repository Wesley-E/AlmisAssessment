...
namespace AlmisAssessment.Tests.Models.Product
{
    public class ProductTests
    {
        private readonly AlmisAssessment.Models.Product.Product _sut;
        ...
        public ProductTests()
        {
            ...
            _sut = new AlmisAssessment.Models.Product.Product("product", _interestRate, term);
        }
        ...
        public void ProductYield_ReturnsCorrectAmount_WhenInvestmentIsCompounded()
        {
            ...
            var sut = new AlmisAssessment.Models.Product.Product("product", _interestRate, term);
